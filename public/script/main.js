...
var account;
var initialAcount = getAccountFromStorage();
if (initialAcount) {
    account = new Account(initialAcount);
...
function createInitialAccount() {
    ...
    var expenseEjemplo = new Entry('Ejemplo gasto', 100, CategoryEnum.expense);
    var incomeEjemplo = new Entry('Ejemplo ingreso', 150, CategoryEnum.income);
...
function updateBlanaceAmount(account) {
